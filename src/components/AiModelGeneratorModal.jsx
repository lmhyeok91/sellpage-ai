...
import { Sparkles, X, Check, RefreshCw, Upload, User, BookmarkCheck, Trash2 } from 'lucide-react';
...
export default function AiModelGeneratorModal({ isOpen, onClose, onSelectAndSaveModel, savedModels, onDeleteSavedModel }) {
  ...
  const sampleGenImages = [
    { id: 1, name: '30대 청년농부 A타입', url: '/example_media/1-1.jpg', prompt: '30대 초반 미소 청년농부 (성주 참외/과일 특화)' },
    { id: 2, name: '30대 청년농부 B타입', url: '/example_media/ChatGPT Image 2026년 8월 3일 오후 10_24_29 (1).png', prompt: '30대 중반 베테랑 농부 (수산/농산 특화)' },
    { id: 3, name: '20대 여성대표 C타입', url: '/example_media/ChatGPT Image 2026년 8월 3일 오후 10_24_29 (2).png', prompt: '20대 후반 여성 산지직송 대표' },
    { id: 4, name: '40대 수산 전문가 D타입', url: '/example_media/ChatGPT Image 2026년 8월 3일 오후 10_24_29 (3).png', prompt: '40대 산지직송 수산물 선별 전문가' }
  ];
  ...
  const handleSaveAndApply = () => {
    ...
    alert('🎉 브랜드 인물 레퍼런스가 계정에 성공적으로 저장 및 적용되었습니다!');
    onClose();
  };
        ...
        {activeTab === 'prompt' && (
          <div>
            ...
            >
              ...
              {isGenerating ? 'AI가 브랜딩 인물 모델 4종을 렌더링하는 중...' : '🚀 AI 브랜드 인물 모델 4종 생성하기'}
            </button>
